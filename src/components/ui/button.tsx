...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:bg-primary/90 shadow-card glow-primary hover:shadow-elevated",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-card",
        outline:
          "border border-border bg-card/50 backdrop-blur-sm hover:bg-accent/50 hover:text-accent-foreground shadow-card",
        secondary:
        ...
        accent: "bg-gradient-accent text-accent-foreground hover:bg-accent/90 shadow-card",
        hero: "bg-gradient-primary text-primary-foreground hover:bg-primary/90 shadow-elevated glow-primary hover:scale-105 transition-bounce font-semibold",
      },
      size: {
